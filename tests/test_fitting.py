...
def test_fit_foster_network_multi_layer(plot_enabled):
    ...
    """
    # 1. Define a "true" 2-layer network to generate synthetic data
    true_network = FosterNetwork(r_values=[0.7, 0.3], c_values=[1.0, 10.0])

    # 2. Generate synthetic impedance data from this true network
    ...
    # 5. Validate the quality of the fit using NRMSE
...
def test_fit_optimal_foster_network_comprehensive(plot_enabled):
    ...
    # 6. Validate the quality of the fit for the selected model
