...
**Z<sub>th</sub>(t) = Σ<sub>i</sub> R<sub>i</sub> · (1 - e<sup>-t/τ<sub>i</sub></sup>)**

where τ<sub>i</sub> = R<sub>i</sub> · C<sub>i</sub>.
...
**Z(s) = Σ<sub>i</sub> R<sub>i</sub> / (1 + s R<sub>i</sub> C<sub>i</sub>)**
